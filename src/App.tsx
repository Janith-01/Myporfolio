...
// Skills data with unique animations and levels
const skills = [
  { name: 'Java', icon: '☕', color: '#ED8B00', animation: 'coffee-steam', level: 100 },
  { name: 'React', icon: '⚛️', color: '#61DAFB', animation: 'spin', level: 100 },
  { name: 'Node.js', icon: '💚', color: '#339933', animation: 'bounce', level: 100 },
  { name: 'MongoDB', icon: '🍃', color: '#47A248', animation: 'leaf-sway', level: 100 },
  { name: 'Python', icon: '🐍', color: '#3776AB', animation: 'snake-wave', level: 65 },
  { name: 'TypeScript', icon: '📘', color: '#3178C6', animation: 'book-flip', level: 70 },
  { name: 'TensorFlow', icon: '🧠', color: '#FF6F00', animation: 'pulse-glow', level: 60 },
  { name: 'Three.js', icon: '🎨', color: '#000000', animation: 'paint-splash', level: 55 },
  { name: 'AWS', icon: '☁️', color: '#FF9900', animation: 'cloud-float', level: 60 },
]
...
const featuredProjects = [
  ...
  },
  {
    ...
    description: 'A modern real-time messaging application with instant message delivery, typing indicators, online status, and group chat features.',
  ...
  },
  {
    ...
    description: 'A comprehensive garage and vehicle management solution with booking system, inventory tracking, and customer management.',
        ...
        <div className="hero-overlay">
          <div className="hero-text">
            ...
            <div className="hero-social">
              ...
              <a href="https://www.linkedin.com/in/janith-viranga-100479385/" target="_blank" rel="noopener noreferrer" className="social-link">
                <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
            ...
            {skills.map((skill) => (
              <div key={skill.name} className="skill-card">
                ...
                <div className="skill-content">
                  <span className={`skill-icon skill-icon--${skill.animation}`}>{skill.icon}</span>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="footer-social">
            ...
            <a href="https://www.linkedin.com/in/janith-viranga-100479385/" target="_blank" rel="noopener noreferrer" className="footer-link">
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
